...
def build(lang):
    ...
    o.append(T["tagline"])
    o.append("")
    o.append("![timeline](assets/timeline.svg)")
    o.append("")
    o.append(T["intro"])
    o.append("")
    ...
    deliv_h = "%d. Deliverables" % (len(groups) + 2)
    o.append("<table>")
    for g in groups:
    ...
    o.append('<tr><td colspan="2"><a href="#%s">%s</a></td></tr>' % (slug(deliv_h), deliv_h if lang == "en" else deliv_h + " (" + T["deliverables_title"] + ")"))
    o.append("</table>")
    o.append("")
    o.append(T["legend"])
    o.append("")
